...
import Ide from '@/apps/workflowAndScriptis/module/ide';
import commonModule from '@/apps/workflowAndScriptis/module/common';
import { NODETYPE, NODEICON } from '@/apps/workflowAndScriptis/service/nodeType'
export default {
  components: {
    Process,
    Ide: Ide.component,
