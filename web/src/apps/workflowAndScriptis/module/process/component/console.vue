...
import result from '@/apps/workflowAndScriptis/module/workbench/script/result.vue';
import log from '@/apps/workflowAndScriptis/module/workbench/script/log.vue';
import weProgress from '@/apps/workflowAndScriptis/module/workbench/script/progress.vue';
import Execute from '@/apps/workflowAndScriptis/module/workbench/script/execute';
export default {
  components: {
    result,
    log,
