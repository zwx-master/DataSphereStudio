...
import weFileTree from '@/components/fileTree';
import weNavbar from '@/components/navbar/navbar.vue';
import newDialog from '@/components/newDialog';
import uploadDialog from '@/components/uploadDialog';
import weImportToHive from '@/components/importToHive';
...
<style src="@/apps/workflowAndScriptis/assets/styles/sidebar.scss" lang="scss"></style>
