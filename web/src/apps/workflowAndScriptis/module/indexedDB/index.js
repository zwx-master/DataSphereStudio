...
import { db } from '@/apps/workflowAndScriptis/service/db/index.js';
import tab from '@/apps/workflowAndScriptis/service/db/tab.js';
import log from '@/apps/workflowAndScriptis/service/db/log.js';
import history from '@/apps/workflowAndScriptis/service/db/history.js';
import result from '@/apps/workflowAndScriptis/service/db/result.js';
import globalcache from '@/apps/workflowAndScriptis/service/db/globalcache.js';
import progress from '@/apps/workflowAndScriptis/service/db/progress.js';
import node from '@/apps/workflowAndScriptis/service/db/node.js';
import project from '@/apps/workflowAndScriptis/service/db/project.js';
export default {
  name: 'IndexedDB',
  events: [],
  methods: {
