...
<script>
import workbenchModule from '@/apps/workflowAndScriptis/module/workbench';
import workSidebarModule from '@/apps/workflowAndScriptis/module/workSidebar';
import fnSidebarModule from '@/apps/workflowAndScriptis/module/fnSidebar';
import hiveSidebarModule from '@/apps/workflowAndScriptis/module/hiveSidebar';
import hdfsSidebarModule from '@/apps/workflowAndScriptis/module/hdfsSidebar';
import { NODETYPE } from '@/apps/workflowAndScriptis/service/nodeType'
export default {
  components: {
