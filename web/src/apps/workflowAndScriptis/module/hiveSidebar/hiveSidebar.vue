...
import weHiveList from '@/components/hiveList';
import WeHiveTableExport from '@/components/hiveTableExport';
...
<style src="@/apps/workflowAndScriptis/assets/styles/sidebar.scss" lang="scss">
</style>
