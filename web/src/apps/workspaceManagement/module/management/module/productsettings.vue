  ...
  <div class="information-box">
    <div
      ...
      <div class="information-text">
        ...
        <label>{{$t('message.workspaceManagemnet.productsetting.status')}}<span>正常</span></label>
...
export default {
  ...
  methods: {
    ...
    init(){
      api.fetch(`/dss/workspaces/${this.$route.query.workspaceId}`, 'get').then(data=>{
        this.workspaceData = data.workspace;
        window.console.log(this.workspaceData, 'this.workspaceData')
      });
